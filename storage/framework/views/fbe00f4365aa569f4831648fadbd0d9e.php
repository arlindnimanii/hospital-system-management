        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary" href="<?php echo e(url('emailview2',$appoint->id)); ?>">Send Mail</a>
                    </td>
                </tr>
...
<?php echo $__env->make('admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\Hospital\resources\views/admin/showappointment.blade.php ENDPATH**/ ?>